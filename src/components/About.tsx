...
const About: React.FC = () => {
    return (
        <div className="container my-5">
            ...
            <span className='underline'>Full Stack Book Club application using the MERN stack and Typescript, as well as a Front End application using Angular 19, Tailwind and Sass.</span> My Neweset Projects are listed below in my current projects section.
            </>
            <br></br>
            <br></br>
